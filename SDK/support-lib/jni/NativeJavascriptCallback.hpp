...
private:
    ...
    const ::djinni::GlobalRef<jclass> clazz { ::djinni::jniFindClass("com/youme/reactcpp/JavascriptCallback") };
    const jmethodID method_invoke { ::djinni::jniGetMethodID(clazz.get(), "invoke", "(Ljava/util/ArrayList;)V") };
    const jmethodID method_invokeSingleArg { ::djinni::jniGetMethodID(clazz.get(), "invokeSingleArg", "(Lcom/youme/reactcpp/JavascriptObject;)V") };
};
